...
# metadata
metadata = {
    'protocolName': 'Station B - RNA extraction - Lisis 1 step',
...
VOLUME_SAMPLE                       = 610   # Volume received from station A
...
run_id                      = 'B_Extraccion_total_Lisis_un_paso'
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    STEPS = { #Dictionary with STEP activation, description, and times
            ...
            13:{'Execute': True, 'description': 'Transferir tercer lavado'},
            14:{'Execute': True, 'description': 'Incubación con el imán ON', 'wait_time': 300},
            15:{'Execute': True, 'description': 'Desechar sobrenadante'},
    ...
    ctx.comment('Wash 3: ' + str(Wash_3.num_wells) + ' canales desde el canal 9 en el reservorio de 12 canales con un volumen de ' + str_rounded(Wash_3.vol_well_original) + ' uL cada uno')
...
###############################################################################
    ...
    Wash_3.reagent_reservoir    = reagent_res.rows()[0][8:10]
